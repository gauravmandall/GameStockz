...
public class BottomGreenFragment extends BottomSheetDialogFragment {
    ...
    private void initElements() {
        ...
        progressDialog.setTitle("Joining Green");
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (ipredictDb == 0) {
                                if (isjoined) {
                                    ...
                                    Task<Void> reference = FirebaseDatabase.getInstance().getReference("Users").child(mobile).child("predict").setValue("2");
                                ...
                                binding.joinGreen.setEnabled(false);
                                binding.joinGreen.setText("Joined");
                                binding.joinGreen.setBackgroundColor(Color.GRAY);
                            }
                        }
    ...
    private void storeDataToCloudFirestore(int tcmoney, String join, int ivalue) {
        ...
        playHistory.put("predict", "2");
        playHistory.put("color", "Green");
